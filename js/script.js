...
const menuLinks = document.querySelectorAll('.sidebar-body-menu a').forEach(link =>{
...
const reportCollapse = document.querySelectorAll('.reportCollapse');

reportCollapse.forEach(rep => {
  const reportList = rep.nextElementSibling.querySelector('.reportList');
  const arrowLeft = rep.querySelector('.arrowLeft');
  const arrowDown = rep.querySelector('.arrowDown');

   // Check the initial display state of the report list
   const isListVisible = reportList.style.display === 'flex';

   // Set initial arrow display based on the report list visibility
   if (isListVisible) {
        ...
        if (sidebarBtn && sidebarBtn) {
          sidebarBtn.addEventListener('click', function () {
            ...
            try {
              ...
              reportCollapse.classList.toggle('r');
